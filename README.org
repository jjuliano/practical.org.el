* practical.org.el
All-in-one pragmatic workflow system for Emacs. Includes a practical GTD system (Getting Things Done), Habit Management, Contact Management and Zettelkasten
Topics
